...
{
    function testSingleInclude():void
    {
...
PHP;
    ...
    function testMultiInclude():void
    {
        $app = new FilterApplication();

        ob_start();
        $fiterConfig = FilterConfig::fromArgs('--include='.ResultPrinter::KEY_DEPRECATIONS.','.ResultPrinter::KEY_UNUSED_SYMBOLS);
        $exitCode = $app->start(__DIR__ . '/fixtures/all-in.neon', $fiterConfig);
        $rendered = ob_get_clean();
